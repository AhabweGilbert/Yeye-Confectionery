                ...
                <div class="col-lg-9 col-md-12 login-card" >
                    <div class="row">
                        <div class="col-md-6 detail-part" style="background-image: url('img/manager/login-balloon.jpg');">
                            ...
                            <p>Fill in all the details shown
                                 </p>
                        </div>
                                  ...
                                  <div class="logo-cover">
                                    ...
                                    <div class="form-cover">
                                        <form action="mregister" method="post">
                                         <input placeholder="Enter First Name" type="text" name="fname" class="form-control">
                                         <input Placeholder="Enter Last Name" type="text" name="lname" class="form-control">
                                         ...
                                         <div class="row form-footer">
                                            Already a manager,
                                             <div style="font-family: Times New Roman;font-weight: bold;color: black">
                                                 <a href="managerlogin.jsp" style="color: blue">Login here</a>     
                                             </div>
                                             <div>&emsp;
                                                 <input type="submit" value="Register" class="btn btn-primary" style="background-color: rgb(4, 131, 250)">
                                             </div>
                                         </div>
                                             </form>
                                    </div>
