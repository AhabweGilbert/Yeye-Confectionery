...
<%
                ...
                ResultSet rs = st.executeQuery("select sum(STotal) from sales where PName ='"+"Bread"+"'");
                rs.next();
                int bread =rs.getInt(1);
                ResultSet rs1 = st.executeQuery("select sum(STotal) from sales where PName ='"+"Doughnuts"+"'");
                rs1.next();
                int doughnuts =rs1.getInt(1);
                ResultSet rs2 = st.executeQuery("select sum(STotal) from sales where PName ='"+"Cake"+"'");
                rs2.next();
                int cake =rs2.getInt(1);
                ResultSet rs3 = st.executeQuery("select sum(STotal) from sales where PName ='"+"Cookies"+"'");
                rs3.next();
                int cookie =rs3.getInt(1);
        ...
        map = new HashMap<Object,Object>(); map.put("label", "bread"); map.put("y", bread); list.add(map);
        map = new HashMap<Object,Object>(); map.put("label", "doughnuts"); map.put("y", doughnuts); list.add(map);
        map = new HashMap<Object,Object>(); map.put("label", "cake"); map.put("y", cake); list.add(map);
        map = new HashMap<Object,Object>(); map.put("label", "cookie"); map.put("y", cookie); list.add(map);
...
<div id="chartContainer" style="height: 370px; width: 100%;"></div>
            ...
            <table style=" width: 100%;">
                <tr>
                    <td><a href="/InterfaceC/report2.jsp"><b>   PREVIOUS REPORT</b></a></td>
                    <td><a href="/InterfaceC/reports.jsp"><b>FIRST REPORT</b></a></td>
            </tr>
            </table>
